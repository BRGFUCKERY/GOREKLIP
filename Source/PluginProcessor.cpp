...
void FRUITYCLIPAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String FRUITYCLIPAudioProcessor::getProgramName (int index)
{
    return {};
}

void FRUITYCLIPAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
void FRUITYCLIPAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
